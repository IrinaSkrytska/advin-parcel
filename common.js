      ...
      function (event) {
        if (event.data === "_apple_ar_quicklook_button_tapped") {
          ...
          window.location.href =
            "https://adv-marketplace.adv.ua/chair.html";
        }
      },
      false
    );
    ...
    linkElement.addEventListener(
      ...
      function (event) {
        if (event.data === "_apple_ar_quicklook_button_tapped") {
          ...
          window.location.href =
            "https://adv-marketplace.adv.ua/washingMachine.html";
        }
      },
      false
    );
    ...
    linkElement.addEventListener(
      ...
      function (event) {
        if (event.data === "_apple_ar_quicklook_button_tapped") {
          ...
          window.location.href =
            "https://adv-marketplace.adv.ua/sofa_red.html";
        }
      },
      false
    );
    ...
    linkElement.addEventListener(
      ...
      function (event) {
        if (event.data === "_apple_ar_quicklook_button_tapped") {
          ...
          window.location.href =
            "https://adv-marketplace.adv.ua/sofa_grey.html";
        }
      },
      false
    );
    ...
    linkElement.addEventListener(
      ...
      function (event) {
        if (event.data === "_apple_ar_quicklook_button_tapped") {
          ...
          window.location.href =
            "https://adv-marketplace.adv.ua/sofa_beige.html";
        }
      },
      false
    );
    ...
    linkElement.addEventListener(
      ...
      function (event) {
        if (event.data === "_apple_ar_quicklook_button_tapped") {
          ...
          window.location.href =
            "https://adv-marketplace.adv.ua/sofa_blue.html";
        }
      },
      false
    );
    ...
    linkElement.addEventListener(
      ...
      function (event) {
        if (event.data === "_apple_ar_quicklook_button_tapped") {
          ...
          window.location.href = "https://adv-marketplace.adv.ua/bath.html";
        }
      },
      false
    );
    ...
    linkElement.addEventListener(
      ...
      function (event) {
        if (event.data === "_apple_ar_quicklook_button_tapped") {
          ...
          window.location.href = "https://adv-marketplace.adv.ua/door.html";
        }
      },
      false
    );
    ...
    linkElement.addEventListener(
      ...
      function (event) {
        if (event.data === "_apple_ar_quicklook_button_tapped") {
          ...
          window.location.href =
            "https://adv-marketplace.adv.ua/kitchenMachine.html";
        }
      },
      false
    );
    ...
    if (IS_IOS_CHROME || IS_IOS_SAFARI || IS_IOS) {
      ...
      fetch(`https://adv-marketplace-back.onrender.com/examples/models/${id}`)
        ...
        .then(({ data }) => {
          ...
          let href = `${iosSrc}#custom=https://adv-marketplace.adv.ua/witnes.html&allowsContentScaling=0`;
          console.log(href);

          const Element = document.getElementById("ar-link");
          Element.href = `${iosSrc}#custom=https://adv-marketplace.adv.ua/witnes.html&allowsContentScaling=0`;
          Element.click();
        });
      ...
      fetch(`https://adv-marketplace-back.onrender.com/examples/models/${id}`, {
        ...
        .then(({ data }) => {
          ...
          if (id === "6400c871099c4fd9483c9a86") {
            href = `intent://arvr.google.com/scene-viewer/1.1?file=${androidSrc}&mode=ar_only&link=https://adv-marketplace.adv.ua/sofa_red.html&title=Go to the order page`;
          ...
          if (id === "6400ca4f0de00735df02fc85") {
            href = `intent://arvr.google.com/scene-viewer/1.1?file=${androidSrc}&mode=ar_only&link=https://adv-marketplace.adv.ua/sofa_blue.html&title=Go to the order page`;
          ...
          if (id === "6400d08c0de00735df02fc87") {
            href = `intent://arvr.google.com/scene-viewer/1.1?file=${androidSrc}&mode=ar_only&link=https://adv-marketplace.adv.ua/sofa_beige.html&title=Go to the order page`;
          ...
          if (id === "6400d0560de00735df02fc86") {
            href = `intent://arvr.google.com/scene-viewer/1.1?file=${androidSrc}&mode=ar_only&link=https://adv-marketplace.adv.ua/sofa_grey.html&title=Go to the order page`;
          ...
          if (id === "6400c871099c4fd9483c9a84") {
            href = `intent://arvr.google.com/scene-viewer/1.1?file=${androidSrc}&mode=ar_only&link=https://adv-marketplace.adv.ua/chair.html&title=Go to the order page`;
          ...
          if (id === "6400c871099c4fd9483c9a85") {
            href = `intent://arvr.google.com/scene-viewer/1.1?file=${androidSrc}&mode=ar_only&link=https://adv-marketplace.adv.ua/washingMachine.html&title=Go to the order page`;
          ...
          if (id === "6400c871099c4fd9483c9a87") {
            href = `intent://arvr.google.com/scene-viewer/1.1?file=${androidSrc}&mode=ar_only&link=https://adv-marketplace.adv.ua/bath.html&title=Go to the order page`;
          ...
          if (id === "6400c871099c4fd9483c9a89") {
            href = `intent://arvr.google.com/scene-viewer/1.1?file=${androidSrc}&mode=ar_only&link=https://adv-marketplace.adv.ua/kitchenMachine.html&title=Go to the order page`;
